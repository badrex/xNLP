...
if args.reload_from_files:
    ...
    print("Reloading!")
    dataset = vectorizer.SurnameDataset.load_dataset_and_load_vectorizer(
        args.surname_csv,
    ...
    # BDR: here the dataset is loaded and the vectorizer is created
    dataset = vectorization.SurnameDataset.load_dataset_and_make_vectorizer(args.surname_csv, n=2)
